...
type RpcRequestMessage struct {
	...
	Target        int64                  `protobuf:"varint,1,opt,name=target,proto3" json:"target,omitempty"` // 玩家id或者服务id，或者为空
...
func (x *RpcRequestMessage) GetTarget() int64 {
	if x != nil {
		return x.Target
	}
	return 0
...
func (x *RpcResponseMessage) GetRoleId() int64 {
	if x != nil {
		return x.RoleId
	}
	return 0
...
func (x *RpcResponseMessage) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *RpcResponseMessage) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
var file_rpc_message_proto_rawDesc = string([]byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x87, 0x01, 0x0a, 0x11, 0x52, 0x70, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65,
	...
	0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x4e, 0x61, 0x6d,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x8f, 0x01,
	0x0a, 0x12, 0x52, 0x70, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18,
